...
class CheckpointInfo:
    def __init__(self, filename):
        ...
        if not self.is_safetensors:
            raise Exception("Only .safetensors model format allowed.")
...
def list_models():
    ...
    model_list = modelloader.load_models(model_path=model_path, model_url=model_url, command_path=shared.cmd_opts.ckpt_dir, ext_filter=[".safetensors"], download_name="v1-5-pruned-emaonly.safetensors", ext_blacklist=[".vae.ckpt", ".vae.safetensors"])
